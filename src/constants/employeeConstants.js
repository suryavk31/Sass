...
export const EMPLOYEE_ADD_TASK_RECORD_REQUEST = "EMPLOYEE_ADD_TASK_RECORD_REQUEST";
export const EMPLOYEE_ADD_TASK_RECORD_SUCCESS = "EMPLOYEE_ADD_TASK_RECORD_SUCCESS";
export const EMPLOYEE_ADD_TASK_RECORD_FAIL = "EMPLOYEE_ADD_TASK_RECORD_FAIL";
